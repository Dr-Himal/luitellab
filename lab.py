...
with col1:
    ...
    st.write("Pubmed: https://pubmed.ncbi.nlm.nih.gov/?term=Himal+luitel&sort=date&size=50")
    st.write("Research Gate: https://www.researchgate.net/profile/Himal-Luitel")
...
with st.container():
    ...
    with tab6:
        ...
        with st.container():
            ...
            contact_form = """
            <form action="https://formsubmit.co/drhimal@gmail.com" method="POST">
